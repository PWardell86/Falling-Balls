...
canvasP = Canvas(masterP, height = heightW, width = widthW)
canvasP.pack()
...
class ball:
    ...
    def __init__(self, colour, shape, size, speed):
        ...
        self.location = [random.randint(0, widthW), random.randint(0, heightW)]
    ...
    def BounceVert(self):
        self.speedVert = round((-self.speedVert * 0.7), 1)  
